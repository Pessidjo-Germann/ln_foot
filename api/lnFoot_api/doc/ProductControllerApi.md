...
# **createProduct**
> ProductDto createProduct(price, categoryNames, id, imageUrl, file, name, description, stockQuantity, sizes)
...
try {
    final result = api_instance.createProduct(price, categoryNames, id, imageUrl, file, name, description, stockQuantity, sizes);
    print(result);
} catch (e) {
...
------------- | ------------- | ------------- | -------------
 **price** | **num**|  | 
 **categoryNames** | [**List<String>**](String.md)|  | 
 **id** | **String**|  | [optional] 
