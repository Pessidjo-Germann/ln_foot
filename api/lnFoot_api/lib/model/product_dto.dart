...
class ProductDto {
  ...
  @override
  String toString() =>
      'ProductDto[price=$price, categoryNames=$categoryNames, id=$id, imageUrl=$imageUrl, file=$file, name=$name, description=$description, stockQuantity=$stockQuantity, sizes=$sizes]';
