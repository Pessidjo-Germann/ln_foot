...
class HeadingDto {
  /// Returns a new [HeadingDto] instance.
  HeadingDto({
    this.id,
    this.title,
    this.imageUrl,
  ...
  /// Returns a new [HeadingDto] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static HeadingDto? fromJson(dynamic value) {
    if (value is Map) {
  ...
  static List<HeadingDto> listFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = HeadingDto.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, HeadingDto> mapFromJson(dynamic json) {
    final map = <String, HeadingDto>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = HeadingDto.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
